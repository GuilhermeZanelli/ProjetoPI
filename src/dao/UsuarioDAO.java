...
public class UsuarioDAO {
    public boolean cadastrar(Usuario usuario) throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            stmt.setBoolean(6, usuario.isAjudaDisponivel());
            ...
            try (ResultSet generatedKeys = stmt.getGeneratedKeys()) {
                if (generatedKeys.next()) {
                    ...
                    String estatSql = "INSERT INTO Estatistica (id_usuario, total_respondidas, total_corretas, total_erradas) VALUES (?, 0, 0, 0)";
    ...
    public List<Usuario> listar() throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            while (rs.next()) {
                ...
                usuario.setAjudaDisponivel(rs.getBoolean("ajudaDisponivel"));
    ...
    public boolean atualizar(Usuario usuario) throws SQLException {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            stmt.setBoolean(4, usuario.isAjudaDisponivel());

 ...
 * @author guilh
 */
public class TelaAdicionarPergunta extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdicionarPerguntas
     */
    ...
    private void initComponents() {
        ...
        telaAdicionarPerguntaLabel = new javax.swing.JLabel();
        ...
        telaAdicionarPerguntaLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/GerenciarPerguntasAdicionar3.png"))); // NOI18N
        getContentPane().add(telaAdicionarPerguntaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void sairButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sairButtonActionPerformed
        var telaMenuPergunta = new TelaMenuGerenciarPerguntas();
        telaMenuPergunta.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdicionarPergunta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdicionarPergunta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel telaAdicionarPerguntaLabel;

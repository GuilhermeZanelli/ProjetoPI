 ...
 * @author guilh
 */
public class TelaMenuPergunta extends javax.swing.JFrame {

    /**
     * Creates new form TelaMenuPergunta
     */
    public TelaMenuPergunta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        telaMenuPerguntaLabel = new javax.swing.JLabel();
        ...
        telaMenuPerguntaLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MenuGerenciarPerguntas_1.png"))); // NOI18N
        getContentPane().add(telaMenuPerguntaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1920, 1080));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaMenuPergunta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaMenuPergunta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel telaMenuPerguntaLabel;

...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(emailTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 630, 730, 40));
        ...
        getContentPane().add(nomeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 600, 180, 30));
        getContentPane().add(nomeTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 630, 670, 40));
        ...
        getContentPane().add(confirmacaoSenhaLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 690, 140, 20));

        confirmacaoSenhaPasswordField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                confirmacaoSenhaPasswordFieldActionPerformed(evt);
            }
        });
        getContentPane().add(confirmacaoSenhaPasswordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 720, 670, 40));
        ...
        getContentPane().add(senhaPasswordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 720, 730, 40));
        ...
        getContentPane().add(cadastrarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 860, 1460, 60));
...
//GEN-LAST:event_entrarButtonActionPerformed
    ...
    private void cadastrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarButtonActionPerformed
        ...
        if (email.contains("@sistemapoliedro.com.br")){
    ...
    private void confirmacaoSenhaPasswordFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmacaoSenhaPasswordFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_confirmacaoSenhaPasswordFieldActionPerformed

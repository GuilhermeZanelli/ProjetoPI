 ...
 * @author guilh
 */
public class TelaGerenciarPerguntasEditar extends javax.swing.JFrame {

    private Pergunta perguntaAtualTela; // Variável para armazenar a pergunta atual
    /**
     * Creates new form TelaGerenciarPerguntasEditar
     */
    public TelaGerenciarPerguntasEditar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenciarPerguntasEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGerenciarPerguntasEditar().setVisible(true);
            }
        });
    }

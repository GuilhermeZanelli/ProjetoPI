...
public class TelaMenuInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(sairButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 790, 370, 120));
        ...
        getContentPane().add(menuButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1270, 620, 380, 130));
        ...
        getContentPane().add(iniciarButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 620, 380, 130));

        telaMenuInicialLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MenuInicial.png"))); // NOI18N
        getContentPane().add(telaMenuInicialLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1920, 1080));

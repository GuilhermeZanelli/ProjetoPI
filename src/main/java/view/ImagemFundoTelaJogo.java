...
public class ImagemFundoTelaJogo extends javax.swing.JFrame {

    public ImagemFundoTelaJogo() {
        initComponents();
        ImagePanel imagePanel = new
        ImagePanel(getClass().getResource("/images/TelaJogo.png"));
    ...
    private void initComponents() {
        ...
        jTextField1.setText("alternativa 1");

        jTextField2.setText("alternativa 2");

        jTextField3.setText("alternativa 3");

        jTextField4.setText("alternativa 4");

        jTextField5.setText("alternativa 5");

        jTextField6.setText("errar");

        jTextField7.setText("parar");

        jTextField8.setText("acertar");

        jTextField9.setText("enunciado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImagemFundoTelaJogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImagemFundoTelaJogo().setVisible(true);
            }
        });
    }
